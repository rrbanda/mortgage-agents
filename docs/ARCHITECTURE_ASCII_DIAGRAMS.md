...
│         │ │         │ │         │ │         │ │         │
│ 5+2=7   │ │ 3+3=6   │ │ 5+1=6   │ │ 6+1=7   │ │ 8+3=11  │
...
║                     27 Operational + 10 Business Rules = 37 Tools  ║
╚════════════════════════════════════════════════════════════════════╝
...
┌────────────────────────────────────────────────────────────────────┐
│ 🏠 APPRAISAL AGENT (7 tools: 6 operational + 1 business rules)     │
├────────────────────────────────────────────────────────────────────┤
│ OPERATIONAL (6):                                                   │
│  ✓ schedule_appraisal                - Schedule & send emails ⭐   │
...
┌────────────────────────────────────────────────────────────────┐
│  TOOLS: 37 Total                                               │
│  ├─ Operational Tools         27 tools (73%)                   │
│  └─ Business Rules Tools      10 tools (27%)                   │
└────────────────────────────────────────────────────────────────┘
...
| AppraisalAgent | 6 | 1 | 7 | **Scheduling + notifications**, valuation |
| UnderwritingAgent | 8 | 3 | 11 | Credit & underwriting |
| **TOTAL** | **27** | **10** | **37** | **Complete mortgage system** |
